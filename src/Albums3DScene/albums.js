...
const albums = [
  ...
  // Left
  { position: [-1.75, 0, 0.25], rotation: [0, Math.PI / 2.5, 0], imgUrl: './5fLOHW1UXr1cJrnXiU3FBt.png', id: '5fLOHW1UXr1cJrnXiU3FBt', name: 'The Album', colorDark: '#C4506D', colorLight: '#D85878' }, 
  ...
  // Right
  { position: [1.75, 0, 0.25], rotation: [0, -Math.PI / 2.5, 0], imgUrl: './1kM6xcSYO5ASJaWgygznL7.png', id: '1kM6xcSYO5ASJaWgygznL7', name: 'ABBA', colorDark: '#482020', colorLight: '#C05555' }, 
